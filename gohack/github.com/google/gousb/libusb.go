...
func (ep libusbEndpoint) BLength() uint8 {
	return uint8(ep.bLength)
}

func (ep libusbEndpoint) BDescriptorType() uint8 {
	return uint8(ep.bDescriptorType)
}

func (ep libusbEndpoint) BEndpointAddress() uint8 {
	return uint8(ep.bEndpointAddress)
}

func (ep libusbEndpoint) BmAttributes() uint8 {
	return uint8(ep.bmAttributes)
}

func (ep libusbEndpoint) WMaxPacketSize() uint16 {
	return uint16(ep.wMaxPacketSize)
}

func (ep libusbEndpoint) BInterval() uint8 {
	return uint8(ep.bInterval)
}

func (ep libusbEndpoint) BRefresh() uint8 {
	return uint8(ep.bRefresh)
}

func (ep libusbEndpoint) BSynchAddress() uint8 {
	return uint8(ep.bSynchAddress)
}
